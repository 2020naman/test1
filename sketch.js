...
function setup() {
  ...
  bob1 = Bodies.circle(400,360,40,bob_options);
  World.add(world,bob1);
	bob2 = Bodies.circle(440,360,40,bob_options);
  World.add(world,bob2);
  bob3 = Bodies.circle(480,360,40,bob_options);
  World.add(world,bob3);
	bob4 = Bodies.circle(360,360,40,bob_options);
  World.add(world,bob4);
	bob5 = Bodies.circle(320,360,40,bob_options);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		Matter.Body.applyForce(bob5,{x:0,y:0},{x:-0.1,y:0});
	}
}